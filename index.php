...
?>
	...
	<main style="margin-top:10px;" class="container">
	<?php 
	if ( have_posts() ) {
		while ( have_posts() ) {
			the_post(); ?>
		
			<article style="background: #3f3f3f; margin: 20px 0" class="img-thumbnail margin">
				<h2><a style="color: white;" href="<?php the_permalink() ;?>" title="<?php the_title() ;?>"><?php the_title() ;?></a></h2>
			</article>
